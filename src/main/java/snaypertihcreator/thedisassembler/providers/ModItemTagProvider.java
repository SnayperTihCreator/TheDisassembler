...
import snaypertihcreator.thedisassembler.tags.ModTags;
...
public class ModItemTagProvider extends ItemTagsProvider {
    public ModItemTagProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> provider,
        ...
        super(output, provider, tagLookup, TheDisassemblerMod.MODID, helper);
    }
    ...
    protected void addTags(HolderLookup.@NotNull Provider provider) {
        ...
        ModItems.CORE_ITEMS.forEach((key, value) -> this.tag(ModTags.BLADES).add(value.get()));
    }
}
