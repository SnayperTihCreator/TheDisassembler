...
public class ModCreativeTabs {
    ...
    public static final RegistryObject<CreativeModeTab> MOD_TAB = CREATIVE_MODE_TABS.register(TheDisassemblerMod.MODID+"_tab", ()->CreativeModeTab.builder()
            .title(Component.translatable(TheDisassemblerMod.MODID+".creative_tab"))
