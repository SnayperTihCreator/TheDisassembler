...
public class ModBlocks {
    ...
    public static final RegistryObject<DisassemblerBlock> BASIC_DISASSEMBLER_BLOCK = registryBlock("basic_disassembler", () -> new DisassemblerBlock(TierTheDisassembler.BASIC));
    public static final RegistryObject<DisassemblerBlock> ADVANCED_DISASSEMBLER_BLOCK = registryBlock("advanced_disassembler", () -> new DisassemblerBlock(TierTheDisassembler.ADVANCED));
    public static final RegistryObject<DisassemblerBlock> PROGRESSIVE_DISASSEMBLER_BLOCK = registryBlock("progressive_disassembler", () -> new DisassemblerBlock(TierTheDisassembler.PROGRESSIVE));
