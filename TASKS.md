...
*   Температура: Зависит от блока снизу.
    *   Костер: 150° (Low).
    *   Костер душ: 250° (Mid).
    *   Магма: 350° (High).
    *   Лава: 500° (Ultra).
...
1.  Предметов.
2.  Блоков (Абстракция).
3.  ТайлЭнтити (Физика тепла, инвентарь, кэширование).
...
4. Регистрация: Собрать всё в ModBlocks, ModItems, ModBlockEntities, ModMenus.
